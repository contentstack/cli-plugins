export const PROCESS_NAMES = {
  ...
  /** Used when Assets module runs Contentstack Assets path (spaces, metadata, folders, assets, downloads). */
  ASSET_MANAGEMENT_SPACES: 'Spaces & assets',

  // Contentstack Assets module
  ASSET_MANAGEMENT_EXPORT: 'Contentstack Assets',
...
export const MODULE_NAMES = {
  ...
  [MODULE_CONTEXTS.CS_ASSETS]: 'Contentstack Assets',
...
export const PROCESS_STATUS = {
  ...
  [PROCESS_NAMES.ASSET_MANAGEMENT_EXPORT]: {
    EXPORTING: 'Exporting...',
    FAILED: 'Contentstack Assets export failed.',
  },
