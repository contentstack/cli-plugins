...
export const JSON_EDITOR_EXTENSION_UID = 'bltb175817fea4631e3';
...
export const MIGRATION_DATA_CONFIG = {
  // Resolved per access so repeated convert runs can change CLI_OUT_DIR (see config.ts).
  get DATA(): string {
    return process.env.CLI_OUT_DIR || './cmsMigrationData';
  },
