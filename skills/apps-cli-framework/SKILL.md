...
description: >-
  ...
  Use when adding flags, init/SDK setup, logging, or organizing command code in
  packages/contentstack-apps-cli.
---

# Apps CLI framework – Apps CLI plugin

## When to use

- Adding or refactoring oclif commands under `packages/contentstack-apps-cli/src/commands/`
...
Domain APIs and manifests: [contentstack-apps](../contentstack-apps/SKILL.md).
